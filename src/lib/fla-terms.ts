...
export function getFlaTermsSections(role: TermsRole) {
  const shared = [
    ...
    },
    {
      ...
      body: 'We collect account, order, and verification data to operate the service. KYC documents for vendors are reviewed for compliance. Contact fadilansalifu58@gmail.com for data questions.',
    },
    {
